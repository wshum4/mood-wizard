...
user_action1 = UserAction.create(
  user: wince,
  action: golf,
  created_at: DateTime.parse('2020-11-04 T 09:00')
  )

user_action2 = UserAction.create(
  user: wince,
  action: boxing,
  created_at: DateTime.parse('2020-11-05 T 09:00')
  )

user_action3 = UserAction.create(
  user: wince,
  action: golf,
  created_at: DateTime.parse('2020-11-06 T 09:00')
  )

user_action4 = UserAction.create(
  user: wince,
  action: yoga,
  created_at: DateTime.parse('2020-11-07 T 13:00')
  )

user_action5 = UserAction.create(
  user: wince,
  action: boxing,
  created_at: DateTime.parse('2020-11-08 T 16:00')
)

user_action6 = UserAction.create(
  user: wince,
  action: paint_class,
  created_at: DateTime.parse('2020-11-09 T 10:00')
  )

user_action7 = UserAction.create(
  user: wince,
  action: archery,
  created_at: DateTime.parse('2020-11-10 T 14:00')
  )

user_action8 = UserAction.create(
  user: wince,
  action: netflix,
  created_at: DateTime.parse('2020-11-10 T 10:00')
  )
...
mood2 = Mood.create(
  ...
  anxious_social: 9,
  created_at: DateTime.parse('2020-11-04 T 23:00'),
...
mood4 = Mood.create(
  ...
  anxious_social: 7,
  created_at: DateTime.parse('2020-11-05 T 23:00'),
...
mood6 = Mood.create(
  ...
  lowenergy_highenergy: 8,
  anxious_social: 8,
  created_at: DateTime.parse('2020-11-06 T 23:00'),
...
mood8 = Mood.create(
  ...
  lowenergy_highenergy: 8,
  anxious_social: 8,
  created_at: DateTime.parse('2020-11-07 T 23:00'),
...
mood10 = Mood.create(
  ...
  anxious_social: 7,
  created_at: DateTime.parse('2020-11-08 T 23:00'),
...
mood12 = Mood.create(
  ...
  lowenergy_highenergy: 6,
  anxious_social: 8,
  created_at: DateTime.parse('2020-11-09 T 23:00'),
...
mood14 = Mood.create(
  ...
  anxious_social: 7,
  created_at: DateTime.parse('2020-11-10 T 23:00'),
